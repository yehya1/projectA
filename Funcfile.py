...
def load_admin_screen():
    ...
    AddIssue = Button(root, text="AddIssue", font=('Times New Roman', 14), bg='green', fg='white', padx=10,command=addIssue)
    AddIssue.place(relx=0.5, rely=0.45, anchor=CENTER)
    AddFault = Button(root, text="AddFault", font=('Times New Roman', 14), bg='green', fg='white', padx=10,command=addFault)
    AddFault.place(relx=0.25, rely=0.45, anchor=CENTER)
    AddProduct = Button(root, text="AddProduct", font=('Times New Roman', 14), bg='green', fg='white', padx=10,command=addProduct)
